...
var content = [
    new UserPageContent_2.Post(1, 'VITAE SED CONDIMENTUM', 'assets/images/p1.jpg', '2016-03-01'),
    new UserPageContent_2.Post(2, 'RUTRUM NEQUE ACCUMSAN', 'assets/images/p2.jpg', '2016-02-01'),
    new UserPageContent_2.Post(3, 'ODIO CONGUE MATTIS', 'assets/images/p3.jpg', '2016-01-01'),
    new UserPageContent_2.Post(4, 'ENIM NISL VEROEROS', 'assets/images/test2.jpg', '2016-05-12'),
    new UserPageContent_2.Post(5, 'ENIM NISL VEROEROS 2', 'assets/images/p4.jpg', '2016-05-12')
];
...
var UserPageContentService = (function () {
    ...
    UserPageContentService.prototype.getContentItem = function (id) {
        return contentPromise
            .then(function (content) { return content.find(function (sontentItem) { return sontentItem.id === +id; }); });
    };

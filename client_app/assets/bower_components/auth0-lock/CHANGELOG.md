...
- [] Fixing default.less merge errors (`Alberto Pose`)
  https://github.com/auth0/lock/commit/cf4bc13a08d68ef39984e817e700e5ad7290ecf7
- [] pixel perfect (`gravityonmars`)
  https://github.com/auth0/lock/commit/e52dbf0d25fae6c52559c2142d939bde2a629f8c
- [] fixes css (`gravityonmars`)
  https://github.com/auth0/lock/commit/77ddfaed1276a0281082761e68617553c29e6a8c
- [] fix overflow problem (`gravityonmars`)
  https://github.com/auth0/lock/commit/efa4c413aae26dbc5faa2a298f254f26fc894bce
- [] Fixing broken translation (`Alberto Pose`)
  https://github.com/auth0/lock/commit/1f0cd7549a9c1253aa26d7668f2b8f63774c82df
- [] Release: 6.5.0 (`Alberto Pose`)
  https://github.com/auth0/lock/commit/f1e518a78996bf266433d3e78ecdd52ba7e31cda
- [] Revert "Release: 6.4.1" (`Alberto Pose`)
  https://github.com/auth0/lock/commit/448820cb492900e2708721c6aee276c3542588fb
- [] Release: 6.4.1 (`Alberto Pose`)
  https://github.com/auth0/lock/commit/72137239a13641e2199c75c78c8659c499aadab4
- [] Fixing broken package.json (`Alberto Pose`)
  https://github.com/auth0/lock/commit/96662a443bde70b2ff8b0d653c503a55b92c0933
- [] Removing duplicate dependency (`Alberto Pose`)
  https://github.com/auth0/lock/commit/301448caeb665f0b016bd5aa3c3951c125eb8416
- [] Reverting credentials. (`Alberto Pose`)
  https://github.com/auth0/lock/commit/1998314c8452ffd460a90a7e1fcce3d09f905644
- [] Merge remote-tracking branch 'vctrfrnndz/password-strength' into password-strength (`Alberto Pose`)
  https://github.com/auth0/lock/commit/70d1444b6ae8a953d6e2b77c7cf255d6999f1d51
- [] Minor: renaming (`Alberto Pose`)
  https://github.com/auth0/lock/commit/f63fc0daba0fe3fa9f981f7cd3ef945e0f859e54
- [] Moving password strength into bindAll. (`Alberto Pose`)
  https://github.com/auth0/lock/commit/6c001a1ece02c277ce8e8fe8c2e85070f22f9014
- [] Enforcing Douce naming suggestions (`Alberto Pose`)
  https://github.com/auth0/lock/commit/572e0767ed07eae4941ca9ed659fac7d1756f434
- [] Better error handling on weak password. (`Alberto Pose`)
  https://github.com/auth0/lock/commit/4bee74e92070dbda3b0441b09067b968e493b428
- [] i18n: Adding invalidPassword message to reset. (`Alberto Pose`)
  https://github.com/auth0/lock/commit/1d9e980db8d6dbde2a56c5c07c13a2b08ae6943e
- [] Adding password strength to reset mode. (`Alberto Pose`)
  https://github.com/auth0/lock/commit/e53ed893e8387e150e8ee8a6feb013ccb1041e52
- [] Password strength implemented (first approach) in Auth0 Lock. (`Alberto Pose`)
  https://github.com/auth0/lock/commit/a9fe02b9524df73c6f80866a8be932aa78a315a2
- [] Merge pull request #78 from auth0/fastly-instead-of-s3 (`Alberto Pose`)
  https://github.com/auth0/lock/commit/093f8cd30b8877e9edecee33227ffa57b6c00671
- [] Fixes #74: Make Lock fetch Auth0 information from CDN (`Alberto Pose`)
  https://github.com/auth0/lock/commit/3be05bf90ce63219f8a728d9c40542899dece6c2
- [] Fixing broken test. (`Alberto Pose`)
  https://github.com/auth0/lock/commit/b1dbf0005e8055e1b6eacc8e26c13b589885f9be
- [] Merge pull request #76 from auth0/revert-75-fastly-instead-of-s3 (`Alberto Pose`)
  https://github.com/auth0/lock/commit/973ad318a0f4c584121d883acecc89dae128faf1
- [] Revert "Fixes #74: Make Lock fetch Auth0 information from CDN" (`Alberto Pose`)
  https://github.com/auth0/lock/commit/51915631b72a32dacfe6bad67c3f5a75aeec6727
- [] Merge pull request #75 from auth0/fastly-instead-of-s3 (`Alberto Pose`)
  https://github.com/auth0/lock/commit/72a6b23ab7179d351e9699344186e61a662980c8
- [] Fixes #74: Make Lock fetch Auth0 information from CDN (`Alberto Pose`)
  https://github.com/auth0/lock/commit/d2cc52f482d30fab826d2241c6ac8388b227cf53
- [] Release: 6.4.0 (`Cristian Douce`)
  https://github.com/auth0/lock/commit/5db277108a4b97a80d03e46913f8124745976e7f
- [] Merge branch 'add/handle_require_username' (`Cristian Douce`)
  https://github.com/auth0/lock/commit/bb933a713921cd906d7663e88465f3dc5f4abc95
- [] Merge branch 'add/theme-option' (`Cristian Douce`)
  https://github.com/auth0/lock/commit/9b8d5d677969d0a4b3197982a8528f7dcdb7276d
- [] Improve gravatar tests speed (`Cristian Douce`)
  https://github.com/auth0/lock/commit/57a9ff15f689b0a9cf0bc2043e3c86aab0769c53
- [] Update tests for requires_username mode for database connection (`Cristian Douce`)
  https://github.com/auth0/lock/commit/574512c4e964303485f4c5f8e69bc695923e0dcd
- [] Merge pull request #2 from pose/password-strength (`Victor Fernandez`)
  https://github.com/auth0/lock/commit/5b285694f702bc6418f681484d2a39d393a3f442
- [] Adding i18n for password policies. (`Alberto Pose`)
  https://github.com/auth0/lock/commit/b235c3e0b5fba598c8a01643ca2b6002c7481e3d
- [] Fix appearace of icons for email/username/password inputs in different modes (`Cristian Douce`)
  https://github.com/auth0/lock/commit/f7a0e8b6937040cee95cb7ca6acd66d40706bfcf
- [] Fix tests for requires_username (`Cristian Douce`)
  https://github.com/auth0/lock/commit/e98bd85558537a2cf43968fe67720a2c963af30e
- [] Fix tests (`Cristian Douce`)
  https://github.com/auth0/lock/commit/f419bc69334e7c86ba0ed699c852a522c47c29a1
- [] Fix placeholder for username when requires_username enabled (`Cristian Douce`)
  https://github.com/auth0/lock/commit/3df63b32c5c6bc6a0366af120c91e4be14f15b98
- [] Fix styles for input borders (`Cristian Douce`)
  https://github.com/auth0/lock/commit/e8fe6c9cecda386331444af985a828f23df9f148
- [] Update to parse and mark username exists error when creating with requires_username database (`Cristian Douce`)
  https://github.com/auth0/lock/commit/5eb414707a992ee55a70e24e8e762f1e0c69bacc
- [] Update input borders for new setup of username+email and any combination (`Cristian Douce`)
  https://github.com/auth0/lock/commit/906552fc65c61749bff5dd8f86fc56e64d0d062b
- [] Remove forgotten debugger (`Cristian Douce`)
  https://github.com/auth0/lock/commit/5b389fa50483861a6ee00f879c51a3fb5088f840
- [] Move _isUsernameRequired to options-manager lib module (`Cristian Douce`)
  https://github.com/auth0/lock/commit/eedf8af250cae6990edfb7546091d5afccb2ed40
- [] Update package.json with latest auth0-js release (`Cristian Douce`)
  https://github.com/auth0/lock/commit/500a3564cba4bd76cbce5d952a30c52457a04390
- [] sign-up tests with `requires_username` (`Matias Corbanini`)
  https://github.com/auth0/lock/commit/72053c72f23d402089069994a560263deb3b0b86
- [] handle `requires_username` in db connection (`Matias Corbanini`)
  https://github.com/auth0/lock/commit/1e53915fafca55cb821fadc65049a1f7068a1d66
- [] Release: 6.3.7 (`Cristian Douce`)
  https://github.com/auth0/lock/commit/21742974d497773cb05e57ff636f13c8a4f6de75
- [] Update font for icons (`Cristian Douce`)
  https://github.com/auth0/lock/commit/5e2ecf63eea6352a84bc8efad09964ecc56f92c4
- [] Merge pull request #1 from pose/password-strength (`Victor Fernandez`)
  https://github.com/auth0/lock/commit/e6e357c6049bffdc1f7a00863c123c46dbfe774a
- [] Fixing how password strength list was rendered. (`Alberto Pose`)
  https://github.com/auth0/lock/commit/6df1ae2b7a62c8d8c99d54d03a0ec7c9aff39d33
- [] Fix iOS focus issue (`Victor Fernandez`)
  https://github.com/auth0/lock/commit/a8846d6f234762ea3e91a73bfc70f713c6f27e7e
- [] Add changelog file History.md. Fix #72 (`Cristian Douce`)
  https://github.com/auth0/lock/commit/2fe09bd162841f6455c2d8f429583742902eed3c
- [] Unify child list color mobile/desktop (`Victor Fernandez`)
  https://github.com/auth0/lock/commit/4592226931ee36fe35dc1010e81a3a593c46cf12
- [] Switch .checked rules to darker green on mobile (`Victor Fernandez`)
  https://github.com/auth0/lock/commit/78e466ee6d4e1ecc58b0dc96308c5bd40623e6ce
- [] Change styling to 2nd iteration (`Victor Fernandez`)
  https://github.com/auth0/lock/commit/22d8bebd67864e338dda6df58b81427d5596f7a4
- [] Fix chaining of CSS for theme default (`Cristian Douce`)
  https://github.com/auth0/lock/commit/cc6769b4b2b1a2699a679dfcc6720bb6917503e7
- [] Move zocial.less as part of the theme default (`Cristian Douce`)
  https://github.com/auth0/lock/commit/7110d4bc06c457683a51dca93ac51988fd9ac5d8
- [] Add theme option with a0-theme-default as default theme. Enables theme-less lock by setting to false (`Cristian Douce`)
  https://github.com/auth0/lock/commit/21037dc4d888a6b226dad3132913b1e678721cce
- [] Update README.md (`Ricardo Rauch`)
  https://github.com/auth0/lock/commit/cf88535d0b7b891272fa5c2a166ed7ab1e1b8778
- [] Update README.md (`Ricardo Rauch`)
  https://github.com/auth0/lock/commit/62a4a5752d8d55508677086f4d9899770147ec08
- [] Update README.md (`Ricardo Rauch`)
  https://github.com/auth0/lock/commit/f29db6694e5d6d782f231281023c015c747302d9
- [] Release: 6.3.6 (`Cristian Douce`)
  https://github.com/auth0/lock/commit/5dfff6b14ce78babb7cd75159aa231023ad36610
- [] Trying position absolute instead of static for overlay (`Cristian Douce`)
  https://github.com/auth0/lock/commit/d7b611e63e020532cce4c348344854775d0b36cc
- [] Remove DS_Store (`Victor Fernandez`)
  https://github.com/auth0/lock/commit/74ebba5fc8475ad73568a616a08e55eb3ff6598c
- [] Always show all the rules (`Victor Fernandez`)
  https://github.com/auth0/lock/commit/209f59c3b48ad88341182b696bdae672d2b19666
- [] Prevent blur from removing the ruleset on smaller screens, as user may need to unfocus to read the whole list (`Victor Fernandez`)
  https://github.com/auth0/lock/commit/c4ba6a9755cc563b41080ff2e4ae7fc19943c87b
- [] Update credentials in example file, add styles and new behavior to password-strength module (`Victor Fernandez`)
  https://github.com/auth0/lock/commit/73e168ec307692d270bdca184848305efb6d6034
- [] Fix README.md (`Cristian Douce`)
  https://github.com/auth0/lock/commit/7ca2f230b9d1587cea252327d5424a7def6a71ea
- [] Fix deploy script oddly not adding build/ after updating .gitignore (`Cristian Douce`)
  https://github.com/auth0/lock/commit/74f30bc8686cb3bfbacebe122fbbda4afd789252
- [] Update deploy script for #70 (`Cristian Douce`)
  https://github.com/auth0/lock/commit/306cac1224bc025ab100841cfad331dc010858b9
- [] Release: 6.3.5 (`Cristian Douce`)
  https://github.com/auth0/lock/commit/26348000905c53b8b64bda36b3998ef179e01455
- [] Update deploy script for #70 with @jfromaniello suggestion (`Cristian Douce`)
  https://github.com/auth0/lock/commit/24d374f587997b74a38210b3db5b061fd63351d4
- [] Release: 6.3.4 (`Cristian Douce`)
  https://github.com/auth0/lock/commit/a32a58e140d9587652ac464e609748325677c5d9
- [] Update pt-BR dictionary (`Cristian Douce`)
  https://github.com/auth0/lock/commit/2f69fdc4d44d8da26e6c40a0c07a99663773077e
- [] Release: 6.3.3 (`Alberto Pose`)
  https://github.com/auth0/lock/commit/4360d53ec2231096a5573aad2c0bb3f29698245e
- [] Update Gruntfile.js (`Cristian Douce`)
  https://github.com/auth0/lock/commit/f0440bdf09c68bec3fabe40b9a2672db882ec1af
- [] Fixing gravatar tests. (`Alberto Pose`)
  https://github.com/auth0/lock/commit/a3977170f0fa8834a68fe864a2874af6d8bf17d5
- [] Merge pull request #67 from dentarg/patch-1 (`Alberto Pose`)
  https://github.com/auth0/lock/commit/d2577a276196d54c95fca36dca02d50597f196f5
- [] Load Gravatar over HTTPS (`Patrik Ragnarsson`)
  https://github.com/auth0/lock/commit/6db06661a17e382a6a0c8a6f4a8b40c90549dd2f
- [] Release: 6.3.2 (`Cristian Douce`)
  https://github.com/auth0/lock/commit/2563caf3696c28ac333f56aba68f01a80913103a
- [] Fix socialBigButtons for showSignup render (`Cristian Douce`)
  https://github.com/auth0/lock/commit/2e66ed3aa3c02be1ab8f5d5db681f31fe52bd56a
- [] Fix tests to avoid random network errors (`Cristian Douce`)
  https://github.com/auth0/lock/commit/ef707122cdd1dd8a768a11c870c2802acc27c2cb
- [] Release: 6.3.1 (`Cristian Douce`)
  https://github.com/auth0/lock/commit/ecae10423ede5d6f6177c1bb1b912055565ea03b
- [] Add tests for callback call when password reset is succesful or not. Fix #62 (`Cristian Douce`)
  https://github.com/auth0/lock/commit/03005be8ee377feba980dc8f145c2995fd276510
- [] Remove missing console.logs (`Cristian Douce`)
  https://github.com/auth0/lock/commit/51a591526aaf91d0f0faa60f9f990a17cddcd260
- [] Fix invoke of callback on password reset action (`Cristian Douce`)
  https://github.com/auth0/lock/commit/9d199395f4a35dbea25b8ac29f6707c53242cfbb
- [] Release: 6.3.0 (`Cristian Douce`)
  https://github.com/auth0/lock/commit/863d11365b9f333043e09af1db29683202f6e794
- [] Bump auth0-js@5.0.0 and fix tests (`Cristian Douce`)
  https://github.com/auth0/lock/commit/42f04c8fbe524f56fcc324437e62865e216d3ab7
- [] Rename defaultADUsernameFromEmail to defaultADUsernameFromEmailPrefix (`Cristian Douce`)
  https://github.com/auth0/lock/commit/f96a92a5c470fe3c6cef4a9624704430c880b973
- [] Rename usernameFromEmail option to defaultADUsernameFromEmail (`Cristian Douce`)
  https://github.com/auth0/lock/commit/7c00af1cad7254f20a03a25f59b3d3d7757f62c3
- [] Update example/index.html (`Cristian Douce`)
  https://github.com/auth0/lock/commit/b287b0119275d156fb70f24cfde4c1f44d18e7c2
- [] Fix container check call (`Cristian Douce`)
  https://github.com/auth0/lock/commit/8e2f2f8eb82ebd4b3632e80bd1ae605b03b4b655
- [] Add properly handling of callback if provided (`Cristian Douce`)
  https://github.com/auth0/lock/commit/5d5f2253b08789d8100c2ef33be800f9576edd51
- [] Rename signupAutoLogin to loginAfterSignup (`Cristian Douce`)
  https://github.com/auth0/lock/commit/f3bc7e9374b1154c9dbf5107256dee174a5b84e6
- [] Update validate and submit methods. Make them part of the constructor and cleanup onsubmit event handler (`Cristian Douce`)
  https://github.com/auth0/lock/commit/aad05db65aff5365c51efe4f77f2085dc80a6480
- [] Add usernameFromEmail default to true for AD signin connections. Related #57 (`Cristian Douce`)
  https://github.com/auth0/lock/commit/fb0651730393483a9005cbe1dee5e1020f329ad4
- [] Add signupAutoLogin first attempt. Related #57 and auth0/widget#29 (`Cristian Douce`)
  https://github.com/auth0/lock/commit/ab585f0359f06eb838deabfd21866c59731d5512
- [] Update README.md (`Martin Gontovnikas`)
  https://github.com/auth0/lock/commit/1fa5c504f1fbda2d3d6a2cfa830c4f77ed8b877d
- [] Release: 6.2.21 (`Cristian Douce`)
  https://github.com/auth0/lock/commit/bc1684155e6c4c8d0a510c023276534239901bfc
- [] Update signup tests (`Cristian Douce`)
  https://github.com/auth0/lock/commit/bbb03e6c7ec7c2caf8e4af314adaf1aa046a9c35
- [] Bump auth0-js@4.3 (`Cristian Douce`)
  https://github.com/auth0/lock/commit/19219a5328a3ce2f500b2cfdda07b1769879b69c
- [] Merge pull request #60 from auth0/terminology (`Cristian Douce`)
  https://github.com/auth0/lock/commit/f9c4af507159a97c3018bf41998c25ad406b0e6f
- [] Use login/log in, signup/sign up and setup/set up consistently (`Rodrigo López Dato`)
  https://github.com/auth0/lock/commit/903a110685f1360b431ed853736672974647c5db
- [] Minor: renaming (`Alberto Pose`)
...
- [] Release: 6.2.20 (`Cristian Douce`)
  https://github.com/auth0/lock/commit/a6fef9f3100434f1baee541f7e5f8a2e9ddc89cf
- [] Add tests for cdn and assetsUrl provided at initialization (`Cristian Douce`)
  https://github.com/auth0/lock/commit/0f75016be0a553ebc451e81d4ad5588610df3c26
- [] Fix assetsUrl and cdn passed to initialization being overriden due to missing parenthesis (`Cristian Douce`)
  https://github.com/auth0/lock/commit/2a09952651c99f3876601ade9841df41c0296ce9
- [] Fix constructor not passing all parameters when not called with new (`Cristian Douce`)
  https://github.com/auth0/lock/commit/97402a25ed760d51d054750905146c947d3889eb
- [] Release: 6.2.19 (`José F. Romaniello`)
  https://github.com/auth0/lock/commit/322163b87f1004ca3805f0bad87ab396bd84634a
- [] fix error with signup on response type code (`José F. Romaniello`)
  https://github.com/auth0/lock/commit/05fc749dac737e9f3249153988eed28132c6c54e
- [] Release: 6.2.18 (`José F. Romaniello`)
  https://github.com/auth0/lock/commit/4531455ede9c6ce9f585d73d94c032486e2d5d19
- [] Merge pull request #56 from auth0/fix_response_code_and_popup (`José F. Romaniello`)
  https://github.com/auth0/lock/commit/1944bb27b2b3cc4420411e0019dc279db661d18f
- [] sso is true by default (`José F. Romaniello`)
  https://github.com/auth0/lock/commit/857a0f0db8d7a2b293fc0bc1a02074962a50eaf3
- [] fix login with popup and response_type=code (`José F. Romaniello`)
  https://github.com/auth0/lock/commit/78940479b8d868f2bdf5c698f9c9319056738574
- [] remove maxcdn (`José F. Romaniello`)
  https://github.com/auth0/lock/commit/041b2fc2037f8a8a0f0232127441262a78372f52
- [] Fix example/index.html (`Cristian Douce`)
  https://github.com/auth0/lock/commit/f3b11d6b667f73e7606f9a25ffad43b98f7c42cc
- [] Release: 6.2.17 (`Alberto Pose`)
  https://github.com/auth0/lock/commit/45825b0d86ba56adda8b9d9c22600a43b3f48ec7
- [] Fixes  #52: PhoneGap "last time you signed in with" is broken (`Alberto Pose`)
  https://github.com/auth0/lock/commit/71c3980e80db0791005ef0295e9da62d9c8d0672
- [] Release: 6.2.16 (`Cristian Douce`)
  https://github.com/auth0/lock/commit/0eaf1fb07316a09c3de9a2e9aad4ff08711ae31f
- [] Fixes #53: Show gravatar picture on "last time you signed in with" (`Alberto Pose`)
  https://github.com/auth0/lock/commit/f3b8c182fca8db77a33ae84bd0eacaf393c06e65
- [] Making jshint happier. (`Alberto Pose`)
  https://github.com/auth0/lock/commit/4277317eac66e8f5c58234d8e5c681eab472f496
- [] Release: 6.2.15 (`Alberto Pose`)
  https://github.com/auth0/lock/commit/a357cef114df8fe735a6073977a1e588fa155973
- [] Fixing broken event re-firing. (`Alberto Pose`)
  https://github.com/auth0/lock/commit/14decea2cea7396b21f27c4f6c3db4c557ebbe3a
- [] Release: 6.2.14 (`Alberto Pose`)
  https://github.com/auth0/lock/commit/b1f4550eac4b898355c5d7e11f597f455fadea9c
- [] Adding new lock translations. (`Alberto Pose`)
  https://github.com/auth0/lock/commit/cb659f64e14411fc0560bd1cae0714ddf33367cd
- [] i18n: Added norwegian (bokmal) (`John Korsnes`)
  https://github.com/auth0/lock/commit/7212c7f152f4900bcad0b0af81feeb0870eb2cb3
- [] Release: 6.2.13 (`Cristian Douce`)
  https://github.com/auth0/lock/commit/daaeabed0351a0c2f5748c8a5c9f387cf5a340d8
- [] Fix tests (`Cristian Douce`)
  https://github.com/auth0/lock/commit/ce9c1f60040f47f71666dca492f9989b2112fe0c
- [] Update header's icon view to lazy load img imgContainer and avatar elements. Fixes issues with tests. (`Cristian Douce`)
  https://github.com/auth0/lock/commit/bc2abe4ac7c7fb637267084c8da3f5a7709922b1
- [] Fix passing callback invoked at the same time to setTimeout wich expects a function (`Cristian Douce`)
  https://github.com/auth0/lock/commit/73ba7d291f549e8121d502c5bf7c422abe17f183
- [] Update codestyle for lib/header files (`Cristian Douce`)
  https://github.com/auth0/lock/commit/7685579ad9c549b24fe354770cd5f86733da27da
- [] Use trim dependency (`Cristian Douce`)
  https://github.com/auth0/lock/commit/1519353fc68908adab128399df3f1aa330a3bfb2
- [] Release: 6.2.12 (`Cristian Douce`)
  https://github.com/auth0/lock/commit/be0077c951e388befc673d625dfa18b43758ee90
- [] Fix debouncing of gravatar only instead of full test input typing. Fixes broken tests (`Cristian Douce`)
  https://github.com/auth0/lock/commit/51033b2b898ee2bb21f3aa137cd7bae10cf0b8b3
- [] Release: 6.2.11 (`Cristian Douce`)
  https://github.com/auth0/lock/commit/fb1ebcc1cb84a1de97c890f14e73bada5c1ce9b1
- [] Add timeout of 3 seconds to load client configuration data. Fixes #48 (`Cristian Douce`)
  https://github.com/auth0/lock/commit/eabbeaaad26a85f0bd3ef373459c0b0ec3028319
- [] Add handler for error on client retrieval. Related #48 (`Cristian Douce`)
  https://github.com/auth0/lock/commit/f556b0b1f4ef3d495b08b97bf0f362cd8ba4d522
- [] Not entering HRD in `username` mode. (`Alberto Pose`)
  https://github.com/auth0/lock/commit/24a46109788a780ca07ec3cf045ddd1e01a74f92
- [] Release: 6.2.10 (`Alberto Pose`)
  https://github.com/auth0/lock/commit/af0d9fe858104d61f142d50d50f22ea04f8b2c33
- [] Fixes #45: Gravatar animation fixes (`Alberto Pose`)
  https://github.com/auth0/lock/commit/337a0b48137e4fe126274ff9457784ad996576bb
- [] Fixes #44: Create unit test for gravatar appearing. (`Alberto Pose`)
  https://github.com/auth0/lock/commit/1b0f5040eee872b2ad3cad15e70d57e90125b0cd
- [] Minor: Style (`Alberto Pose`)
  https://github.com/auth0/lock/commit/ca1b403741934157c42389c50fb36fd5ee0b3a3f
- [] Fixes #43: Move ImageView out of HeaderView (`Alberto Pose`)
  https://github.com/auth0/lock/commit/adce57cd12844f2e7e3bb41e81509c86736e6d9c
- [] Minor: Removing /index from requires as redudant. (`Alberto Pose`)
  https://github.com/auth0/lock/commit/4512c5393f8933081aa8fe3273a777df76c77a1a
- [] Adding jshint rule that prevents alt+160 character. (`Alberto Pose`)
  https://github.com/auth0/lock/commit/ddb7d7c74907173579a355171abd5f1ebdd10df8
- [] Release: 6.2.9 (`Alberto Pose`)
  https://github.com/auth0/lock/commit/3574436c8e8296609212a5d1776e92e95f7a8351
- [] Fixes #47: On HRD take input email and use the first part as suggested username (`Alberto Pose`)
  https://github.com/auth0/lock/commit/cc33e02a07b34f7f47a4dbb0c1c637b0780639d7
- [] Fixes #46: Gravatar image not being displayed on HRD mode. (`Alberto Pose`)
  https://github.com/auth0/lock/commit/226473c274b36a869acc059e8a820f1ff84293f5
- [] Changing zuul file to run faster based on #lock feedback. (`Alberto Pose`)
  https://github.com/auth0/lock/commit/b7ddd00820756e90b4e239de17bafa18419dc77e
- [] Release: 6.2.8 (`Alberto Pose`)
  https://github.com/auth0/lock/commit/1cb1cea19b7e7ea5e259799e8d0ce0373d351fcb
- [] Fixing wrong filtering of AD connections on HRD mode. (`Alberto Pose`)
  https://github.com/auth0/lock/commit/457bf87ca6e2343eae241cb1168d1836b70c06e3
- [] Release: 6.2.7 (`Alberto Pose`)
  https://github.com/auth0/lock/commit/e80353cbc9c82bd440c96cb08015a51e5b2acc85
- [] Minor: border-radius of a0-image to 58px. (`Alberto Pose`)
  https://github.com/auth0/lock/commit/2c1f5e48bdbe48993e107ecaab1f7720c7600b24
- [] Release: 6.2.6 (`Alberto Pose`)
  https://github.com/auth0/lock/commit/1778a0679dc662f98cccfc3678dd95e600f7b0cc
- [] First attempt to fine tune in which platforms our tests run. (`Alberto Pose`)
  https://github.com/auth0/lock/commit/f895c3b148fd5def4d49e3550f941322c289f3f8
- [] Removing character alt+space. (`Alberto Pose`)
  https://github.com/auth0/lock/commit/e4e686aa492928141f0b14f880427ab45acdfa97
- [] Merge pull request #41 from auth0/gravatar-image (`Alberto Pose`)
  https://github.com/auth0/lock/commit/476969971c54dc01bc0ef023cc34f50bdec0f697
- [] Implements gravatar flag. (`Alberto Pose`)
  https://github.com/auth0/lock/commit/01b5d751ff79693c7ed28b7c734f5d153790cea7
- [] Adding md5 dependency. (`Alberto Pose`)
  https://github.com/auth0/lock/commit/c46b77a3abb7bdb4a07829f45b222c4889670fdc
- [] CSS: Adding icon-container and animation fast class. (`Alberto Pose`)
  https://github.com/auth0/lock/commit/fc3453341da7fc544fb0305560d8551ae2eaefc2
- [] Moving header.ejs to header folder. (`Alberto Pose`)
  https://github.com/auth0/lock/commit/eca6db338d9bfc99e98cffbb42af5222d7b89b6a
- [] Improving how supports-animation work. (`Alberto Pose`)
  https://github.com/auth0/lock/commit/facd150b5039466f0720dffdac3a24b51e5ffe05
- [] Adding gravatar flag. (`Alberto Pose`)
  https://github.com/auth0/lock/commit/dfea66a4e453910c5866ec220e412036778d7c8c
- [] Making gravatar picture circuled. (`Alberto Pose`)
  https://github.com/auth0/lock/commit/4fc46a159a03b5cbaebaeb80e415c5e4af9584ee
- [] Adding a0_once and a0_one. (`Alberto Pose`)
  https://github.com/auth0/lock/commit/da31a4bbd92f1527a29b75ec616ca6955c9154cd
- [] Release: 6.2.5 (`José F. Romaniello`)
  https://github.com/auth0/lock/commit/120ad2d2a9f5b56c6fe5334b3d02a3f069299079
